                        ...
                        <div className="flex flex-row gap-8 max-[440px]:flex-col">
                          ...
                          <div className="w-full max-[440px]:text-center">
                            ...
                            <p className="mt-2 text-sm text-gray-700">
                              Warung Halal-Indonesia milik NEOJAPAN yang
                              terletak di Suzuka, Mie-ken, hanya beberapa menit
                              dari Stasiun Tsuzumigaura dan Shiroko. Tempat ini
                              menyajikan makanan halal khas Indonesia dengan
                              rasa autentik dan suasana yang ramah. Cocok untuk
                              kamu yang mencari cita rasa Indonesia di Jepang.
                              <br />
                              <br />
                              📍{" "}
                              <a
                      ...
                      {modalContent === "Logo2" && (
                        <div className="flex flex-row gap-8 max-[440px]:flex-col">
                          ...
                          <div className="w-full max-[440px]:text-center">
                            ...
                            <p className="mt-2 text-sm text-gray-700">
                              We are committed to delivering Japan's finest
                              foods and products to customers around the world.
                              Our products, which combine Japan's tradition and
                              innovation, consistently meet the highest
                              standards, offering safety and reliability. Our
                              mission is to spread the value of Japan’s
                              exceptional technology and materials across
                              borders, gaining recognition in the global market.
                              <br />
                              <br />
                              📍{" "}
                              <a
